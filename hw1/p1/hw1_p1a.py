...
Original file is located at
    https://colab.research.google.com/drive/1MJc3txt2L6IthN4oRSyvDxuMOvrA6j1b
"""
...
train_transform = transforms.Compose([
    transforms.Resize((128, 128)), #image size 128*128
...
for epoch in range(num_epoch):
    ...
    scheduler.step()
    if epoch == 0:
      torch.save(model.state_dict(), f"p1a_epoch_0.ckpt")
    if epoch == 39:
      torch.save(model.state_dict(), f"p1a_epoch_39.ckpt")
    if v_acc > best_acc:
      torch.save(model.state_dict(), f"p1a_best_model.ckpt")
      print(f"best model: epoch {epoch}, save model")
      best_acc = v_acc
    else:
      print(f"no improve: epoch {epoch}.")

torch.save(model.state_dict(), f"p1a_epoch_99.ckpt")
